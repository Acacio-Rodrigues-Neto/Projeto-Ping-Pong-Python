...
root = Tk()
root.title("Ping Pong - Duda e Enzo")
root.resizable(0,0)
root.wm_attributes("-topmost", -1)

# Variável recebendo o resultado da função Canvas
canvas = Canvas(root, width=600, height=700, bd=0,highlightthickness=0)
canvas.pack()
root.update()
...
# Função
def score():
    canvas.itemconfig(score_now, text="Pontos Duda: " + str(count))
...
score_now = canvas.create_text(430, 20, text="Pontos Duda: " + str(count), fill = "green", font=("Arial", 16))
